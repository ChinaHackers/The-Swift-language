...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        segmented.setContentOffset(CGSizeMake(3,2),forSegmentAtIndex:1)
...
//         segmented.insertSegmentWithImage(UIImage(named:"icon")!,atIndex:1,animated: true)
        ...
        // 监听ValueChanged 事件
        segmented.addTarget(self, action: #selector(ViewController.segmentDidchange(_:)), forControlEvents: UIControlEvents.ValueChanged)
